...
VALUES 
('Interstellar', 2014, 'A team of explorers travel through a wormhole in space to ensure humanity’s survival, facing time dilation, distant galaxies, and emotional challenges.', 169, 10, 0, '[0,7]'),
('The Dark Knight', 2008, 'Batman faces the Joker, a criminal mastermind who pushes Gotham into chaos, forcing the hero to confront his own moral limits and the true meaning of justice.', 152, 12, 0, '[0,21]'),
('Inception', 2010, 'A skilled thief who steals secrets through dreams is offered a chance to have his past erased, but only if he can plant an idea in someone’s subconscious.', 148, 12, 0, '[0,17,21]'),
('The Matrix', 1999, 'A hacker learns that reality is a simulation and joins a rebellion to fight intelligent machines, discovering his destiny as "The One" in a cyberpunk world.', 136, 15, 0, '[0,17]'),
('Titanic', 1997, 'A poor artist and an aristocratic woman fall in love aboard the ill-fated RMS Titanic, defying social norms and enduring tragedy as the ship sinks.', 194, 12, 0, '[16,7]'),
('The Shawshank Redemption', 1994, 'Wrongly imprisoned for murder, a man maintains hope and friendship as he plans a daring escape from prison over decades, transforming those around him.', 142, 15, 0, '[7]'),
('Pulp Fiction', 1994, 'Intertwined tales of violence and redemption in Los Angeles follow gangsters, a boxer, and hitmen in a nonlinear narrative filled with dark humor and grit.', 154, 18, 0, '[5,21]'),
('Forrest Gump', 1994, 'A simple man with a big heart recounts his accidental influence on historic events and his unwavering love for his childhood friend, Jenny.', 142, 10, 0, '[7,16]'),
('The Godfather', 1972, 'A mafia patriarch hands over the reins of his crime empire to his reluctant son, setting off a tale of power, loyalty, and the cost of family legacy.', 175, 15, 0, '[5,7]'),
('Fight Club', 1999, 'An insomniac office worker forms an underground fight club with a soap salesman, leading to chaos and a startling revelation about identity.', 139, 18, 0, '[7,21]'),
('The Empire Strikes Back', 1980, 'The rebels suffer a major defeat by the Empire, while Luke Skywalker seeks Jedi training and faces shocking truths about his lineage.', 124, 8, 0, '[0,1,17]'),
('Gladiator', 2000, 'A betrayed Roman general seeks revenge as a gladiator, fighting for justice and to honor his murdered family in the corrupt empire of Rome.', 155, 15, 0, '[0,7]'),
('Jurassic Park', 1993, 'Cloned dinosaurs escape containment on a theme park island, forcing scientists and visitors into a desperate fight for survival amid prehistoric terror.', 127, 10, 0, '[0,17]'),
('The Lion King', 1994, 'A lion cub flees after tragedy but must embrace his destiny and return to save his homeland from a tyrannical ruler and reclaim his rightful place.', 88, 6, 0, '[2,8]'),
('Avengers: Endgame', 2019, 'The Avengers reunite for one last mission to reverse a cosmic catastrophe, traveling through time and facing great loss to save the universe.', 181, 12, 0, '[0,20]'),
('The Lord of the Rings: The Fellowship of the Ring', 2001, 'A hobbit and his allies begin a perilous journey to destroy a powerful ring and stop a dark lord’s rise in a mythical world filled with danger and hope.', 178, 12, 0, '[0,1,9]'),
('Star Wars: A New Hope', 1977, 'A young farm boy joins the Rebel Alliance, learning the ways of the Force to fight against the oppressive Galactic Empire and its deadly weapon.', 121, 8, 0, '[0,17]'),
('Back to the Future', 1985, 'A teenager is accidentally sent back in time and must ensure his parents fall in love to secure his own existence while finding a way home.', 116, 8, 0, '[1,17]'),
('The Silence of the Lambs', 1991, 'A young FBI trainee seeks help from a brilliant but dangerous serial killer to catch another murderer who skins his victims, racing against time.', 118, 18, 0, '[21]'),
('Schindler''s List', 1993, 'A German businessman saves the lives of over a thousand Jews during the Holocaust, risking everything as he witnesses the horrors of war firsthand.', 195, 15, 0, '[3,7,11]'),
('The Green Mile', 1999, 'A death row guard discovers an inmate with miraculous powers, forcing him to question justice, humanity, and the mysteries of life and death.', 189, 15, 0, '[7,9]'),
('Spirited Away', 2001, 'A young girl enters a magical world ruled by spirits and gods, where she must work, adapt, and outwit supernatural beings to save her parents.', 125, 8, 0, '[2,9]'),
('The Departed', 2006, 'An undercover cop infiltrates the mob while a mole rises in the police force, leading to a tense game of deception and deadly consequences.', 151, 18, 0, '[5,21]'),
('Mad Max: Fury Road', 2015, 'In a post-apocalyptic wasteland, a drifter and a rebel leader fight for freedom from a tyrant in a relentless, high-octane desert chase.', 120, 15, 0, '[0,21]'),
('Parasite', 2019, 'A poor family cons its way into working for a wealthy household, but unexpected twists unravel their plan in a darkly comic tale of inequality.', 132, 15, 0, '[7,21]'),
('Jaws', 1975, 'A massive shark terrorizes a coastal town, prompting a police chief, scientist, and fisherman to hunt the creature in a battle for survival.', 124, 12, 0, '[21]'),
('Alien', 1979, 'A space crew responds to a distress call and unknowingly brings aboard a deadly alien lifeform, fighting for survival in deep space.', 117, 15, 0, '[17,12]'),
('Toy Story', 1995, 'Toys come to life when humans aren’t around, and a new arrival threatens the bond between a cowboy doll and a space ranger in this adventure.', 81, 6, 0, '[2,8]'),
('The Big Lebowski', 1998, 'A slacker becomes entangled in a kidnapping case after being mistaken for someone else, navigating absurd situations and bowling alleys.', 117, 15, 0, '[4,5]'),
('Blade Runner', 1982, 'In a dystopian future, a blade runner hunts rogue androids while questioning what it means to be human in a world blurred by artificial life.', 117, 15, 0, '[17,21]'),
('The Avengers', 2012, 'Earth’s mightiest heroes must learn to work together to stop a powerful alien invasion led by Loki, threatening global destruction.', 143, 12, 0, '[0,20]'),
('Whiplash', 2014, 'A young drummer enrolls in a music conservatory and faces brutal training under a perfectionist instructor, testing his limits and ambition.', 107, 12, 0, '[7,13]'),
('Django Unchained', 2012, 'A freed slave joins a bounty hunter on a quest to rescue his wife from a brutal plantation owner in a bloody, stylish tale of vengeance.', 165, 18, 0, '[7,23]'),
('The Grand Budapest Hotel', 2014, 'A concierge and his protégé become embroiled in a murder mystery involving a stolen painting and a wealthy family in a fictional Europe.', 99, 12, 0, '[4,7]'),
('Memento', 2000, 'A man suffering from short-term memory loss hunts his wife’s killer using tattoos and notes, struggling to separate truth from illusion.', 113, 15, 0, '[15,21]'),
('No Country for Old Men', 2007, 'A hunter discovers a briefcase of money and becomes the target of a relentless killer in a bleak, violent tale of chance and fate.', 122, 18, 0, '[21]'),
('Saving Private Ryan', 1998, 'During WWII, soldiers embark on a perilous mission to find and return home the last surviving brother of a family who lost the rest in battle.', 169, 15, 0, '[0,22]'),
('The Truman Show', 1998, 'A man discovers his entire life is a scripted TV show, prompting an existential journey to find truth, freedom, and his real identity.', 103, 10, 0, '[7]'),
('Se7en', 1995, 'Two detectives hunt a serial killer who uses the seven deadly sins as motives for his crimes, leading to a disturbing and unforgettable ending.', 127, 18, 0, '[5,21]'),
('The Wolf of Wall Street', 2013, 'A stockbroker rises to outrageous wealth through fraud and excess, descending into a whirlwind of drugs, women, and federal investigations.', 180, 18, 0, '[3,4]'),
('La La Land', 2016, 'A jazz musician and an aspiring actress pursue their dreams and fall in love, facing the reality of ambition and the choices it demands.', 128, 12, 0, '[7,13,16]');
